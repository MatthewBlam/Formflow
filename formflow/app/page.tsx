...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      {/* Nav — sits directly on the mint background, no separate container */}
      ...
      {/* Main content — same background, no card/box */}
        ...
        {isProcessing ? (
          <div className="flex flex-1 flex-col items-center justify-center gap-10 py-16">
            ...
            <div className="relative flex items-center justify-center">
              ...
              <div className="absolute size-24 rounded-full border-4 border-primary border-t-transparent animate-spin" />
            </div>
